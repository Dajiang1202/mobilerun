...
OCR_ROIS: list[tuple[str, str]] = [
    ...
    # 注: hp(血量)/shop_toggle/continue_btn(结算) 暂不识别(省算力), 后续按需再加
    # 问号掉落物识别区 (暂时全图, 后面标小框提速)
    ("drop_region", "问号掉落物识别区 (暂时留空=全图)"),
    ("home", "老巢位置 (战斗末/收完掉落物走回这里)"),
]
